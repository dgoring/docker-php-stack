# php8.0-fpm + apache2 + mariadb
Docker image based on the image `php:8.0-fpm` with apache added on, this is for my personal use but if you have any suggestions please add an issue or create a pull request
...
```yaml
  web:
    image: dgoring/php-stack:8.0-apache
    restart: always
    volumes:
